...
class ArtsAdapter() : ListAdapter<ArtsDomain, ArtsAdapter.ArtsViewHolder>(diffUtil) {
    ...
    companion object {
        val diffUtil = object : DiffUtil.ItemCallback<ArtsDomain>() {
            override fun areItemsTheSame(oldItem: ArtsDomain, newItem: ArtsDomain): Boolean =
                oldItem.id == newItem.id

            override fun areContentsTheSame(oldItem: ArtsDomain, newItem: ArtsDomain): Boolean {
